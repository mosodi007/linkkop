/**
 * Countries with dial codes and ISO 3166-1 alpha-2 for flag emoji.
 * Synced with web packages/web/src/app/data/countries.ts
 */
...
const RAW_COUNTRIES: { country: string; code: string; iso: string }[] = [
...
export const COUNTRY_OPTIONS: CountryOption[] = RAW_COUNTRIES.map(({ country, code, iso }) => {
